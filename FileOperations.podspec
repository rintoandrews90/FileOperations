#
#  Be sure to run `pod spec lint FileOperations.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.description  = <<-DESC
                   This Library contains methods for iOS file operations. This library helps developers to easily implement file operations
			DESC
  ...
  spec.source       = { :git => "https://github.com/rintoandrews90/FileOperations.git", :tag => "0.0.15"  }
  ...
  spec.source_files  = "FileOperations", "FileOperations/**/*.{h,m,swift}"
  spec.exclude_files = "FileOperations/Exclude"
